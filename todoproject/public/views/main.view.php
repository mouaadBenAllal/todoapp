    ...
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
                ...
                <a class="navbar-brand" href="<?php ROOT_URL;?>todos">TODO'S</a>

        </div>
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo ROOT_URL;?>todos/index">Overzicht</a></li>
                <?php if(isset($_SESSION['isLoggedIn']) && $_SESSION['user_info']['role'] == 3) :?>
                    <li><a href="<?php echo ROOT_URL;?>users/register">Add user</a></li>
                <?php endif;?>
            </ul>
